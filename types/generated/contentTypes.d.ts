...
export interface ApiBlogpostBlogpost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    blog_post_content: Schema.Attribute.Blocks & Schema.Attribute.Required;
    blog_post_description: Schema.Attribute.Text & Schema.Attribute.Required;
    blog_post_image_url: Schema.Attribute.Text & Schema.Attribute.Required;
    blog_post_status: Schema.Attribute.Enumeration<
      ['save', 'draft', 'publish']
    > &
      Schema.Attribute.Required &
...
export interface ApiBookmarkBookmark extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    blogposts: Schema.Attribute.Relation<
      ...
      'api::blogpost.blogpost'
    >;
    bookmark_status: Schema.Attribute.Enumeration<['saved', 'unsaved']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category_url: Schema.Attribute.Text &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiCommentComment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    comments_status: Schema.Attribute.Enumeration<['active', 'inactive']> &
      Schema.Attribute.Required &
...
export interface ApiDomainDomain extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    domain_name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    domain_status: Schema.Attribute.Enumeration<['active', 'inactive']> &
...
export interface ApiLikeLike extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    like_status: Schema.Attribute.Enumeration<['like', 'dislike']>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
